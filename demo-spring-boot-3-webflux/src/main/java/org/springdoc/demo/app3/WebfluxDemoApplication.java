...
public class WebfluxDemoApplication {
    ...
    @Bean
    public GroupedOpenApi otherOpenApi(@Value("${springdoc.version}") String appVersion) {
        String[] paths = {"/**"};
        return GroupedOpenApi.builder().
                group("others")
                .addOpenApiCustomizer(openApi -> openApi.info(new Info().title("Other API").version(appVersion)))
                .pathsToMatch(paths)
                .build();
    }
